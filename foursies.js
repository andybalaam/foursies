...
var _andybalaam$foursies$Board$pieceToChar = function (piece) {
	var _p0 = piece;
	switch (_p0.ctor) {
		case 'NoPiece':
...
var _andybalaam$foursies$Board$rowToString = function (row) {
	var _p1 = row;
	var piece0 = _p1._0;
	var piece1 = _p1._1;
	var piece2 = _p1._2;
	...
	return _elm_lang$core$String$fromList(
		{
			ctor: '::',
			_0: _andybalaam$foursies$Board$pieceToChar(piece0),
			_1: {
				ctor: '::',
				_0: _andybalaam$foursies$Board$pieceToChar(piece1),
				_1: {
					ctor: '::',
					_0: _andybalaam$foursies$Board$pieceToChar(piece2),
					_1: {
						ctor: '::',
						_0: _andybalaam$foursies$Board$pieceToChar(piece3),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _andybalaam$foursies$Board$positions = {
	ctor: '::',
...
var _andybalaam$foursies$Board$newBoard = function (p11) {
	return function (p21) {
		return function (p31) {
			return function (p41) {
				return function (p12) {
														...
														return function (p34) {
															return function (p44) {
																return {
																	pieces: {
																		ctor: '_Tuple4',
																		_0: {ctor: '_Tuple4', _0: p11, _1: p21, _2: p31, _3: p41},
																		_1: {ctor: '_Tuple4', _0: p12, _1: p22, _2: p32, _3: p42},
																		_2: {ctor: '_Tuple4', _0: p13, _1: p23, _2: p33, _3: p43},
																		_3: {ctor: '_Tuple4', _0: p14, _1: p24, _2: p34, _3: p44}
																	}
																};
															};
														};
...
var _andybalaam$foursies$Board$Board = function (a) {
	return {pieces: a};
};
var _andybalaam$foursies$Board$OffBoard = {ctor: 'OffBoard'};
var _andybalaam$foursies$Board$offBoard = _andybalaam$foursies$Board$OffBoard;
var _andybalaam$foursies$Board$pieceInRow = F2(
	function (x, row) {
		var _p2 = row;
		var p0 = _p2._0;
		var p1 = _p2._1;
		...
		switch (_p3) {
			...
			case 3:
				return p3;
			default:
				return _andybalaam$foursies$Board$offBoard;
		}
	});
var _andybalaam$foursies$Board$pieceAt = F2(
	function (_p4, board) {
		var _p5 = _p4;
		var _p8 = _p5._0;
		var _p6 = board.pieces;
		var row0 = _p6._0;
		var row1 = _p6._1;
		var row2 = _p6._2;
		var row3 = _p6._3;
		...
		switch (_p7) {
			case 0:
				return A2(_andybalaam$foursies$Board$pieceInRow, _p8, row0);
			case 1:
				return A2(_andybalaam$foursies$Board$pieceInRow, _p8, row1);
			case 2:
				return A2(_andybalaam$foursies$Board$pieceInRow, _p8, row2);
			case 3:
				return A2(_andybalaam$foursies$Board$pieceInRow, _p8, row3);
			default:
				return _andybalaam$foursies$Board$offBoard;
		}
	});
var _andybalaam$foursies$Board$XPiece = {ctor: 'XPiece'};
var _andybalaam$foursies$Board$xPiece = _andybalaam$foursies$Board$XPiece;
var _andybalaam$foursies$Board$OPiece = {ctor: 'OPiece'};
var _andybalaam$foursies$Board$oPiece = _andybalaam$foursies$Board$OPiece;
var _andybalaam$foursies$Board$NoPiece = {ctor: 'NoPiece'};
var _andybalaam$foursies$Board$noPiece = _andybalaam$foursies$Board$NoPiece;
var _andybalaam$foursies$Board$parseChar = function (c) {
	var _p9 = c;
	switch (_p9.valueOf()) {
		case '.':
			return _elm_lang$core$Result$Ok(_andybalaam$foursies$Board$noPiece);
		case 'O':
			return _elm_lang$core$Result$Ok(_andybalaam$foursies$Board$oPiece);
		case 'X':
			return _elm_lang$core$Result$Ok(_andybalaam$foursies$Board$xPiece);
		default:
			return _elm_lang$core$Result$Err(
				A2(
...
var _andybalaam$foursies$Board$parseRow = function (line) {
	var _p10 = _elm_lang$core$String$toList(line);
	if (((((_p10.ctor === '::') && (_p10._1.ctor === '::')) && (_p10._1._1.ctor === '::')) && (_p10._1._1._1.ctor === '::')) && (_p10._1._1._1._1.ctor === '[]')) {
		var ps = {
			ctor: '_Tuple4',
			_0: _andybalaam$foursies$Board$parseChar(_p10._0),
			_1: _andybalaam$foursies$Board$parseChar(_p10._1._0),
			_2: _andybalaam$foursies$Board$parseChar(_p10._1._1._0),
			_3: _andybalaam$foursies$Board$parseChar(_p10._1._1._1._0)
		};
		var _p11 = ps;
		if (_p11._0.ctor === 'Err') {
			return _elm_lang$core$Result$Err(
				A2(_elm_lang$core$Basics_ops['++'], _p11._0._0, ' (char 1)'));
		} else {
			if (_p11._1.ctor === 'Err') {
				return _elm_lang$core$Result$Err(
					A2(_elm_lang$core$Basics_ops['++'], _p11._1._0, ' (char 2)'));
			} else {
				if (_p11._2.ctor === 'Err') {
					return _elm_lang$core$Result$Err(
						A2(_elm_lang$core$Basics_ops['++'], _p11._2._0, ' (char 3)'));
				} else {
					if (_p11._3.ctor === 'Err') {
						return _elm_lang$core$Result$Err(
							A2(_elm_lang$core$Basics_ops['++'], _p11._3._0, ' (char 3)'));
					} else {
						return _elm_lang$core$Result$Ok(
							{ctor: '_Tuple4', _0: _p11._0._0, _1: _p11._1._0, _2: _p11._2._0, _3: _p11._3._0});
					}
				}
			}
		}
	} else {
		return _elm_lang$core$Result$Err('Line does not contain 4 characters');
	}
};
var _andybalaam$foursies$Board$parse = function (strs) {
	var _p12 = strs;
	var parsed = {
		ctor: '_Tuple4',
		_0: _andybalaam$foursies$Board$parseRow(_p12._0),
		_1: _andybalaam$foursies$Board$parseRow(_p12._1),
		_2: _andybalaam$foursies$Board$parseRow(_p12._2),
		_3: _andybalaam$foursies$Board$parseRow(_p12._3)
	};
	var _p13 = parsed;
	if (_p13._0.ctor === 'Err') {
		return _elm_lang$core$Result$Err(
			A2(_elm_lang$core$Basics_ops['++'], _p13._0._0, ' (line 1)'));
	} else {
		if (_p13._1.ctor === 'Err') {
			return _elm_lang$core$Result$Err(
				A2(_elm_lang$core$Basics_ops['++'], _p13._1._0, ' (line 2)'));
		} else {
			if (_p13._2.ctor === 'Err') {
				return _elm_lang$core$Result$Err(
					A2(_elm_lang$core$Basics_ops['++'], _p13._2._0, ' (line 3)'));
			} else {
				if (_p13._3.ctor === 'Err') {
					return _elm_lang$core$Result$Err(
						A2(_elm_lang$core$Basics_ops['++'], _p13._3._0, ' (line 4)'));
				} else {
					return _elm_lang$core$Result$Ok(
						{
							pieces: {ctor: '_Tuple4', _0: _p13._0._0, _1: _p13._1._0, _2: _p13._2._0, _3: _p13._3._0}
						});
				}
			}
		}
...
var _andybalaam$foursies$Board$Strings = F4(
	function (a, b, c, d) {
		return {ctor: 'Strings', _0: a, _1: b, _2: c, _3: d};
	});
var _andybalaam$foursies$Board$strings = F4(
	function (line1, line2, line3, line4) {
		return A4(_andybalaam$foursies$Board$Strings, line1, line2, line3, line4);
	});
var _andybalaam$foursies$Board$toStrings = function (board) {
	var _p14 = board.pieces;
	var row0 = _p14._0;
	var row1 = _p14._1;
	var row2 = _p14._2;
	var row3 = _p14._3;
	return A4(
		_andybalaam$foursies$Board$Strings,
		_andybalaam$foursies$Board$rowToString(row0),
		_andybalaam$foursies$Board$rowToString(row1),
		_andybalaam$foursies$Board$rowToString(row2),
		_andybalaam$foursies$Board$rowToString(row3));
};
...
var _andybalaam$foursies$Model$sidePlayer = F2(
	function (model, side) {
		var _p1 = side;
		if (_p1.ctor === 'XSide') {
			return model.chosenPlayers.x;
		} else {
			return model.chosenPlayers.o;
		}
	});
var _andybalaam$foursies$Model$Flags = F2(
	function (a, b) {
		return {width: a, height: b};
	});
...
var _andybalaam$foursies$Model$oppositeSide = function (side) {
	var _p2 = side;
	if (_p2.ctor === 'XSide') {
		return _andybalaam$foursies$Model$OSide;
	} else {
...
var _andybalaam$foursies$Model$BlackPlayer = {ctor: 'BlackPlayer'};
var _andybalaam$foursies$Model$allPlayers = {
	ctor: '::',
	_0: _andybalaam$foursies$Model$BlackPlayer,
	_1: {
		ctor: '::',
		_0: _andybalaam$foursies$Model$WhitePlayer,
		_1: {
			ctor: '::',
			_0: _andybalaam$foursies$Model$GreenPlayer,
			_1: {
				ctor: '::',
				_0: _andybalaam$foursies$Model$BluePlayer,
				_1: {ctor: '[]'}
			}
		}
	}
...
var _andybalaam$foursies$Model$TouchedState = F2(
	function (a, b) {
		return {ctor: 'TouchedState', _0: a, _1: b};
	});
...
var _andybalaam$foursies$Msg$Touched = F2(
	function (a, b) {
		return {ctor: 'Touched', _0: a, _1: b};
	});
...
var _andybalaam$foursies$Msg$ChoosePlayer = function (a) {
	return {ctor: 'ChoosePlayer', _0: a};
};
var _andybalaam$foursies$Msg$Resize = F2(
	function (a, b) {
...
var _andybalaam$foursies$Moves$whoWon = function (board) {
	...
	return A2(
		...
		}) ? _andybalaam$foursies$Board$oPiece : (A2(
		_elm_lang$core$List$member,
		_andybalaam$foursies$Board$xPiece,
		{
			ctor: '::',
			_0: b0,
			_1: {
...
var _andybalaam$foursies$Moves$movePiecePiece = F4(
	function (board, pos, piece, move) {
		return _elm_lang$core$Native_Utils.eq(
			_andybalaam$foursies$Moves$from(move),
			pos) ? _andybalaam$foursies$Board$noPiece : (_elm_lang$core$Native_Utils.eq(
			_andybalaam$foursies$Moves$to(move),
			pos) ? A2(
			_andybalaam$foursies$Board$pieceAt,
			_andybalaam$foursies$Moves$from(move),
...
var _andybalaam$foursies$Moves$movePiece = F2(
	function (board, move) {
		return {
			pieces: A3(_andybalaam$foursies$Moves$movePieceRows, board, board.pieces, move)
		};
	});
var _andybalaam$foursies$Moves$Take = F3(
	function (a, b, c) {
		return {ctor: 'Take', _0: a, _1: b, _2: c};
	});
var _andybalaam$foursies$Moves$take = F3(
	function (from, over, to) {
		return A3(_andybalaam$foursies$Moves$Take, from, over, to);
	});
var _andybalaam$foursies$Moves$Hop = F3(
	function (a, b, c) {
		return {ctor: 'Hop', _0: a, _1: b, _2: c};
	});
var _andybalaam$foursies$Moves$hop = F3(
	function (from, over, to) {
		return A3(_andybalaam$foursies$Moves$Hop, from, over, to);
	});
var _andybalaam$foursies$Moves$Slide = F2(
	function (a, b) {
		return {ctor: 'Slide', _0: a, _1: b};
	});
var _andybalaam$foursies$Moves$slide = F2(
	function (from, to) {
		return A2(_andybalaam$foursies$Moves$Slide, from, to);
	});
var _andybalaam$foursies$Moves$movesForPos = F3(
	function (side, board, pos) {
		return A2(
			_elm_lang$core$List$filter,
			A2(_andybalaam$foursies$Moves$allowedMove, side, board),
			{
				ctor: '::',
				_0: A2(
					_andybalaam$foursies$Moves$slide,
					pos,
					A2(
						_andybalaam$foursies$Moves$adjust,
						pos,
									...
									_1: {
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: A3(
													_andybalaam$foursies$Moves$hop,
													pos,
													A2(
														_andybalaam$foursies$Moves$adjust,
														pos,
																	...
																	_1: {
																		...
																		_1: {
																			...
																			_1: {
																				ctor: '::',
																				_0: A3(
																					_andybalaam$foursies$Moves$take,
																					pos,
																					A2(
																						_andybalaam$foursies$Moves$adjust,
																						pos,
		...
		switch (_p19.ctor) {
			...
			default:
				var ourPieces = A2(
					...
					function (pos) {
						return _elm_lang$core$Native_Utils.eq(
							A2(_andybalaam$foursies$Board$pieceAt, pos, board),
							side);
					},
					_andybalaam$foursies$Board$positions);
				return _andybalaam$foursies$Moves$anyTakesMeansOnlyTakes(
					_elm_lang$core$List$concat(
						A2(
							_elm_lang$core$List$map,
							A2(_andybalaam$foursies$Moves$movesForPos, side, board),
							ourPieces)));
		}
	});
...
var _andybalaam$foursies$Moves$Won = function (a) {
	return {ctor: 'Won', _0: a};
};
var _andybalaam$foursies$Moves$CanMovePositions = function (a) {
	return {ctor: 'CanMovePositions', _0: a};
};
var _andybalaam$foursies$Moves$whichCanMove = F2(
	function (side, board) {
		...
		switch (_p23.ctor) {
			...
			case 'OPiece':
				return _andybalaam$foursies$Moves$Won(_andybalaam$foursies$Board$oPiece);
			default:
				return _andybalaam$foursies$Moves$CanMovePositions(
					_andybalaam$foursies$Moves$unique(
						A2(
							_elm_lang$core$List$map,
							_andybalaam$foursies$Moves$from,
							A2(_andybalaam$foursies$Moves$allowedMoves, side, board))));
		}
	});

var _andybalaam$foursies$PixelScale$pieceWidth = 20;
var _andybalaam$foursies$PixelScale$backgroundWidth = 200;
var _andybalaam$foursies$PixelScale$piecesScale = 2.198;
var _andybalaam$foursies$PixelScale$boardWidth = function (model) {
	var minD = A2(_elm_lang$core$Basics$min, model.screen.width, model.screen.height);
	return _elm_lang$core$Basics$round(
		_elm_lang$core$Basics$toFloat(minD) * 0.9);
};
var _andybalaam$foursies$PixelScale$boardScale = function (model) {
	return _elm_lang$core$Basics$toFloat(
		_andybalaam$foursies$PixelScale$boardWidth(model)) / _andybalaam$foursies$PixelScale$backgroundWidth;
};
var _andybalaam$foursies$PixelScale$gridDistance = F3(
	function (model, dragMouseStart, mouseEnd) {
		var sc = (_andybalaam$foursies$PixelScale$pieceWidth * _andybalaam$foursies$PixelScale$boardScale(model)) * _andybalaam$foursies$PixelScale$piecesScale;
		var movedY = mouseEnd.y - dragMouseStart.y;
		var movedX = mouseEnd.x - dragMouseStart.x;
		return {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Basics$round(
				_elm_lang$core$Basics$toFloat(movedX) / sc),
			_1: _elm_lang$core$Basics$round(
				_elm_lang$core$Basics$toFloat(movedY) / sc)
		};
	});
var _andybalaam$foursies$PixelScale$boardDistance = F3(
	function (model, startPx, endPx) {
		var pixelsMovedY = endPx.y - startPx.y;
		var pixelsMovedX = endPx.x - startPx.x;
		var sc = _andybalaam$foursies$PixelScale$boardScale(model) * _andybalaam$foursies$PixelScale$piecesScale;
		var movedX = _elm_lang$core$Basics$toFloat(pixelsMovedX) / sc;
		var movedY = _elm_lang$core$Basics$toFloat(pixelsMovedY) / sc;
...
var _andybalaam$foursies$View$tickImage = F3(
	function (model, xpos, ypos) {
		...
		if ((_p0.ctor === 'Just') && (_p0._0.ctor === 'DragState')) {
			var _p1 = A3(_andybalaam$foursies$PixelScale$gridDistance, model, _p0._0._2, model.mousePos);
			var draggedX = _p1._0;
			var draggedY = _p1._1;
			return _elm_lang$core$Native_Utils.eq(
				{ctor: '_Tuple2', _0: _p0._0._0 + draggedX, _1: _p0._0._1 + draggedY},
				{ctor: '_Tuple2', _0: xpos, _1: ypos}) ? 'images/big-tick.svg' : 'images/tick.svg';
		} else {
...
var _andybalaam$foursies$View$beingDraggedOffsets = F2(
	function (model, dMousePos) {
		var _p2 = A3(_andybalaam$foursies$PixelScale$boardDistance, model, dMousePos, model.mousePos);
		var movedX = _p2._0;
		var movedY = _p2._1;
		var offsetY = -1;
		var offsetX = -1;
...
var _andybalaam$foursies$View$offsets = F3(
	function (model, xpos, ypos) {
		...
		if ((_p3.ctor === 'Just') && (_p3._0.ctor === 'DragState')) {
			return ((!_elm_lang$core$Native_Utils.eq(_p3._0._0, xpos)) || (!_elm_lang$core$Native_Utils.eq(_p3._0._1, ypos))) ? {ctor: '_Tuple4', _0: 0, _1: 0, _2: 0, _3: 0} : A2(_andybalaam$foursies$View$beingDraggedOffsets, model, _p3._0._2);
		} else {
...
var _andybalaam$foursies$View$playerImage = function (player) {
	...
	switch (_p4.ctor) {
		...
		case 'WhitePlayer':
			return 'images/piece-white.svg';
		case 'GreenPlayer':
			return 'images/piece-green.svg';
		default:
			return 'images/piece-blue.svg';
	}
};
var _andybalaam$foursies$View$playerStyle = function (player) {
	return {
		ctor: '::',
		_0: {
			ctor: '_Tuple2',
			...
			_1: A2(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					_andybalaam$foursies$View$playerImage(player),
					'\')'))
		},
		_1: {ctor: '[]'}
	};
};
var _andybalaam$foursies$View$playerChoiceInput = F2(
		...
		return {
			...
			_0: A2(
				_elm_lang$html$Html$input,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('chplayer'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$style(
								_andybalaam$foursies$View$playerStyle(player)),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(
									A2(_andybalaam$foursies$Msg$ChangePlayer, side, player)),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _andybalaam$foursies$View$playerChoiceSpan = F2(
	function (model, side) {
		var oppSide = _andybalaam$foursies$Model$oppositeSide(side);
		return A2(
			_elm_lang$html$Html$span,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('choose-player'),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$style(
						{
			...
			_elm_lang$core$List$concat(
				A2(
					_elm_lang$core$List$map,
					_andybalaam$foursies$View$playerChoiceInput(side),
					A2(
						_elm_lang$core$List$filter,
						function (p) {
							return !_elm_lang$core$Native_Utils.eq(
								p,
								A2(_andybalaam$foursies$Model$sidePlayer, model, oppSide));
						},
						_andybalaam$foursies$Model$allPlayers))));
	});
var _andybalaam$foursies$View$choosePlayerInput = F2(
	function (model, side) {
		return A2(
			_elm_lang$html$Html$input,
			{
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$style(
							_andybalaam$foursies$View$playerStyle(
								A2(_andybalaam$foursies$Model$sidePlayer, model, side))),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(
								_andybalaam$foursies$Msg$ChoosePlayer(side)),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _andybalaam$foursies$View$boardSide = F3(
	function (model, side, _p6) {
		...
		var _p8 = A3(_andybalaam$foursies$View$offsets, model, _p9, _p10);
		var pieceX = _p8._0;
		var pieceY = _p8._1;
		var shadowX = _p8._2;
		var shadowY = _p8._3;
		var cx_ = _elm_lang$core$Basics$toString(
			shadowX + A2(scale, 14.5, _p9));
		var cy_ = _elm_lang$core$Basics$toString(
			shadowY + A2(scale, 14.5, _p10));
		var x_ = _elm_lang$core$Basics$toString(
			pieceX + A2(scale, 3.1, _p9));
		var y_ = _elm_lang$core$Basics$toString(
			pieceY + A2(scale, 3.1, _p10));
		return {
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$cx(cx_),
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$cy(cy_),
						_1: {
							ctor: '::',
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$opacity('0.6'),
									_1: {
										ctor: '::',
										_0: _andybalaam$foursies$View$filterAtt('url(#blur)'),
										_1: {ctor: '[]'}
									}
								}
							}
	...
	function (model, pos) {
		...
		switch (_p11.ctor) {
			...
			case 'OffBoard':
				return {ctor: '[]'};
			case 'XPiece':
				return A3(_andybalaam$foursies$View$boardSide, model, _andybalaam$foursies$Model$XSide, pos);
			default:
				return A3(_andybalaam$foursies$View$boardSide, model, _andybalaam$foursies$Model$OSide, pos);
		}
	});
...
var _andybalaam$foursies$View$boardTick = F3(
	function (model, handleMouseDown, _p12) {
		var _p13 = _p12;
		var _p15 = _p13._1;
		var _p14 = _p13._0;
		var scale = F2(
			...
			A2(
						...
						_1: {
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$xlinkHref(
										A3(_andybalaam$foursies$View$tickImage, model, _p14, _p15)),
									_1: {
										ctor: '::',
										_0: _andybalaam$foursies$View$onTouchStart(
											A2(_andybalaam$foursies$Msg$Touched, _p14, _p15)),
										_1: {ctor: '[]'}
									}
								}
							}
				...
				handleMouseDown ? {
					...
					_0: _elm_lang$svg$Svg_Events$onMouseDown(
						A2(_andybalaam$foursies$Msg$DragStart, _p14, _p15)),
					_1: {ctor: '[]'}
				} : {ctor: '[]'}),
			{ctor: '[]'});
	});
var _andybalaam$foursies$View$boardTicks = function (model) {
	...
	var _p16 = model.dragging;
	if (_p16.ctor === 'Nothing') {
		var _p17 = A2(_andybalaam$foursies$Moves$whichCanMove, piece, model.board);
		if (_p17.ctor === 'Won') {
			return {ctor: '[]'};
		} else {
			return A2(
...
var _andybalaam$foursies$View$boardPieces = function (model) {
	return A2(
		_elm_lang$svg$Svg$g,
		{
			ctor: '::',
			_0: _elm_lang$svg$Svg_Attributes$transform(
				A2(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						_elm_lang$core$Basics$toString(_andybalaam$foursies$PixelScale$piecesScale),
						A2(
							_elm_lang$core$Basics_ops['++'],
							', ',
							A2(
		...
		A2(
			_elm_lang$core$Basics_ops['++'],
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$id('blur'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$stdDeviation('0.5'),
								_1: {ctor: '[]'}
							},
							{ctor: '[]'}),
						_1: {ctor: '[]'}
			...
			A2(
				...
				_elm_lang$core$List$concat(
					A2(
						_elm_lang$core$List$map,
						_andybalaam$foursies$View$boardPiece(model),
						_andybalaam$foursies$Board$positions)),
				_andybalaam$foursies$View$boardTicks(model))));
};
var _andybalaam$foursies$View$boardSvg = function (model) {
	var wstr = _elm_lang$core$Basics$toString(
		_andybalaam$foursies$PixelScale$boardWidth(model));
	var scale = _elm_lang$core$Basics$toString(
		_andybalaam$foursies$PixelScale$boardScale(model));
	return A2(
									...
									_1: {
										...
										_1: {
											...
											_0: _elm_lang$svg$Svg_Attributes$width(
												_elm_lang$core$Basics$toString(_andybalaam$foursies$PixelScale$backgroundWidth)),
											_1: {
												ctor: '::',
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$svg$Svg$text('Foursies'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$svg$Svg$text('A deceptively simple two-player board game'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
...
var _andybalaam$foursies$Update$oppositePlayer = F2(
	function (model, side) {
		return A2(
			_andybalaam$foursies$Model$sidePlayer,
			model,
			_andybalaam$foursies$Model$oppositeSide(side));
	});
var _andybalaam$foursies$Update$updatePlayer = F3(
	function (model, side, player) {
		var chpl_ = model.chosenPlayers;
		var chpl = function () {
			if (_elm_lang$core$Native_Utils.eq(
				A2(_andybalaam$foursies$Update$oppositePlayer, model, side),
				player)) {
				return chpl_;
			} else {
				var _p0 = side;
		...
		return _elm_lang$core$Native_Utils.update(
			model,
			{choosingSide: _elm_lang$core$Maybe$Nothing, chosenPlayers: chpl});
	});
var _andybalaam$foursies$Update$updateResize = F3(
	function (w, h, model) {
		var scr = model.screen;
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				screen: _elm_lang$core$Native_Utils.update(
					scr,
					{width: w, height: h})
			});
	});
		...
		if (_p1.ctor === 'YesAllowed') {
			return _elm_lang$core$Native_Utils.update(
				model,
				{
					dragging: _elm_lang$core$Maybe$Nothing,
					message: _andybalaam$foursies$Model$MessageNormal,
					board: A2(_andybalaam$foursies$Moves$movePiece, model.board, _p1._0),
...
var _andybalaam$foursies$Update$moveIsFromAndTo = F3(
	function (fromPos, toPos, move) {
		return _elm_lang$core$Native_Utils.eq(
			_andybalaam$foursies$Moves$to(move),
			toPos) && _elm_lang$core$Native_Utils.eq(
			_andybalaam$foursies$Moves$from(move),
			fromPos);
	});
...
var _andybalaam$foursies$Update$YesAllowed = function (a) {
	return {ctor: 'YesAllowed', _0: a};
};
var _andybalaam$foursies$Update$moveAllowed = F5(
	function (model, startX, startY, endX, endY) {
		if (_elm_lang$core$Native_Utils.eq(startX, endX) && _elm_lang$core$Native_Utils.eq(startY, endY)) {
			return _andybalaam$foursies$Update$NotAllowed(_andybalaam$foursies$Model$MessageNormal);
		} else {
			var thisMove = A2(
				_elm_lang$core$List$filter,
				A2(
					_andybalaam$foursies$Update$moveIsFromAndTo,
					{ctor: '_Tuple2', _0: startX, _1: startY},
					{ctor: '_Tuple2', _0: endX, _1: endY}),
				A2(
					_andybalaam$foursies$Moves$allowedMoves,
					_andybalaam$foursies$Model$sidePiece(model.turn),
					model.board));
			var _p2 = _elm_lang$core$List$head(thisMove);
			if (_p2.ctor === 'Nothing') {
				return _andybalaam$foursies$Update$NotAllowed(_andybalaam$foursies$Model$MessageMoveNotAllowed);
			} else {
				return _andybalaam$foursies$Update$YesAllowed(_p2._0);
			}
		}
	});
var _andybalaam$foursies$Update$dragMoveAllowed = F4(
	function (model, xpos, ypos, startPx) {
		var _p3 = A3(_andybalaam$foursies$PixelScale$gridDistance, model, startPx, model.mousePos);
		var moveX = _p3._0;
		var moveY = _p3._1;
...
var _andybalaam$foursies$Update$updateDragStop = function (model) {
	var _p4 = model.dragging;
	if ((_p4.ctor === 'Just') && (_p4._0.ctor === 'DragState')) {
		return A2(
			_andybalaam$foursies$Update$updateTryMove,
			model,
			A4(_andybalaam$foursies$Update$dragMoveAllowed, model, _p4._0._0, _p4._0._1, _p4._0._2));
	} else {
		return model;
	}
};
var _andybalaam$foursies$Update$updateTouched = F3(
	function (xpos, ypos, model) {
		...
		if ((_p5.ctor === 'Just') && (_p5._0.ctor === 'TouchedState')) {
			return A2(
				_andybalaam$foursies$Update$updateTryMove,
				model,
				A5(_andybalaam$foursies$Update$moveAllowed, model, _p5._0._0, _p5._0._1, xpos, ypos));
		} else {
			return _elm_lang$core$Native_Utils.update(
				model,
				{
					dragging: _elm_lang$core$Maybe$Just(
						A2(_andybalaam$foursies$Model$TouchedState, xpos, ypos))
				});
		}
	});
var _andybalaam$foursies$Update$update = F2(
	function (msg, model) {
		var m = function () {
			...
			switch (_p6.ctor) {
				case 'Resize':
					return A3(_andybalaam$foursies$Update$updateResize, _p6._0, _p6._1, model);
				case 'ChoosePlayer':
					return _elm_lang$core$Native_Utils.update(
						model,
						{
							choosingSide: _elm_lang$core$Maybe$Just(_p6._0)
						});
				case 'ChangePlayer':
				...
				case 'MouseMove':
					return _elm_lang$core$Native_Utils.update(
						...
						{mousePos: _p6._0});
				case 'DragStart':
					return A3(_andybalaam$foursies$Update$updateDragStart, _p6._0, _p6._1, model);
				case 'DragStop':
...
var _andybalaam$foursies$Main$init = function (flags) {
	return {
		ctor: '_Tuple2',
		_0: _andybalaam$foursies$Model$newModel(flags),
		_1: _elm_lang$core$Platform_Cmd$none
	};
};
var _andybalaam$foursies$Main$subscriptions = function (model) {
...
var _andybalaam$foursies$Main$main = _elm_lang$html$Html$programWithFlags(
	{init: _andybalaam$foursies$Main$init, view: _andybalaam$foursies$View$view, update: _andybalaam$foursies$Update$update, subscriptions: _andybalaam$foursies$Main$subscriptions})(
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (height) {
			return A2(
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _andybalaam$foursies$Main$main !== 'undefined') {
    _andybalaam$foursies$Main$main(Elm['Main'], 'Main', undefined);
}
